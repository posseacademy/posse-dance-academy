...
**現在のバージョン (2026-04-20):**
- `app.html`: `style.css?v=23`, `app.js?v=80`
- `app.js`: `config.js?v=11`, `utils.js?v=7`, `firebase-service.js?v=8`
- `app.js`: `home.js?v=13`, `customers.js?v=13`, `attendance.js?v=35`, `schedule.js?v=24`, `revenue.js?v=12`
- `app.js`: `csv-export.js?v=11`
