...
**現在のバージョン (2026-04-20):**
- `app.html`: `style.css?v=24`, `app.js?v=81`
- `app.js`: `config.js?v=12`, `utils.js?v=8`, `firebase-service.js?v=8`
- `app.js`: `home.js?v=14`, `customers.js?v=13`, `attendance.js?v=36`, `schedule.js?v=24`
