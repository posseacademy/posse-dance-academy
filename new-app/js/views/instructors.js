  ...
  return `
    <div class="instructors-view">
      <div class="page-header">
        <h1 class="page-title">è¬å¸«ãã­ãã£ã¼ã«</h1>
      </div>
            ...
            <div class="card-body" style="padding:var(--spacing-6)">
              ...
              ${inst.awards && inst.awards.length > 0 ? `
                <div style="margin-top:var(--spacing-4)">
                  <h3 style="font-size:1rem;margin-bottom:var(--spacing-2);color:var(--color-text-secondary)">åè³æ­´ã»å®ç¸¾</h3>
              ...
              ${inst.otherExperience && inst.otherExperience.length > 0 ? `
                <div style="margin-top:var(--spacing-3)">
                  <h3 style="font-size:1rem;margin-bottom:var(--spacing-2);color:var(--color-text-secondary)">åºæ¼ã»æ´»å</h3>
                  <div style="display:flex;flex-wrap:wrap;gap:var(--spacing-2)">
              ...
              ${inst.lessons && inst.lessons.length > 0 ? `
                <div style="margin-top:var(--spacing-3)">
                  <h3 style="font-size:1rem;margin-bottom:var(--spacing-2);color:var(--color-text-secondary)">æå°æ­´</h3>
                  <div style="display:flex;flex-wrap:wrap;gap:var(--spacing-2)">
                    ${inst.lessons.map(l => `
